...
const MODULE_META = [
  {id:"about", title:"About", desc:"Canonical publication scope, release identity, and access date.", accent:"#0f8f6b", grad:"linear-gradient(135deg,#0f8f6b,#12a17a)", icon:"info"},
  {id:"documentation", title:"Documentation", desc:"Versioned metadata, checksums, change log, and supplementary tables.", accent:"#2f6bff", grad:"linear-gradient(135deg,#2f6bff,#6aa1ff)", icon:"book"},
  {id:"species", title:"Species & Stages", desc:"10 manuscript-associated taxa with matrix counts, sample columns and developmental stage coverage.", accent:"#0f8f6b", grad:"linear-gradient(135deg,#0f8f6b,#12a17a)", icon:"leaf"},
  ...
  {id:"data", title:"Transcriptome Data", desc:"30 public FPKM / CPM / read-count matrices comprising 239 sample columns.", accent:"#0f8f6b", grad:"linear-gradient(135deg,#0f8f6b,#3aa981)", icon:"table"},
